...
@Repository
@Transactional
public class DoctorCRepositoryImpl implements IDoctorCRepository {

	private static final Logger LOG = Logger.getLogger(DoctorCRepositoryImpl.class);
	...
	public Doctor buscarPorCedula(String cedula) {
		...
		TypedQuery<Doctor> myQuery = this.entityManager.createQuery("SELECT d FROM Doctor1 d WHERE d.cedula = :cedula",
				Doctor.class);
